		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Process Sales Order V2",
									"targetURL": "#comsapfioriprocesssalesorderv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapfioriprocesssalesorderv2-display": {
								"semanticObject": "comsapfioriprocesssalesorderv2",
								"action": "display",
								"description": "Process Sales Order V2",
								"title": "Process Sales Order V2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.fiori.processsalesorderv2",
									"url": sap.ui.require.toUrl("com/sap/fiori/processsalesorderv2")
								}
							}
						}
					}
